...
public class Log_RecyAdapter extends RecyclerView.Adapter<Log_RecyAdapter.VH> {
    ...
    public void onBindViewHolder(@NonNull VH vh, int i) {
        ...
        vh.item_portrait.setImageResource(R.drawable.portrait111);
        vh.item_space.setText((String) map.get("space"));
        vh.item_date.setText((String)map.get("date"));
        vh.item_picture.setImageResource(R.drawable.day1);
        ...
        if (i == 1){
            vh.item_picture.setImageResource(R.drawable.apple);
        }
    }
